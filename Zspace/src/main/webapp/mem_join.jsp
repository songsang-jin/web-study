 ...
 <div id="contents"> <!-- 사이드 제외 전체구역 -->
     ...
     <table id="mem_join_tb" align="center" border="2px solid gray">
      ...
      <tr>
       ...
       <td><input type="text" name="mem_id">
           <button type="button" id="idbtn" onclick="idCheck(joinform, '${root}')">중복확인</button>
       </td>
      </tr>
      <tr>
  ...
  - 공백 입력 불가능">
      ...
      <tr id="addr">
        ...
        <td valign="middle">
        	<input type="text" name="mem_zipcode"  id="mem_zipcode" readonly>
           <input type="button" onclick="searchZipcode()" id="zipbtn"  value="우편번호검색"><p></p>
           <input type="text" id="mem_addr1" name="mem_addr1">&nbsp;  
           <input type="text"  id="mem_addr2" name="mem_addr2" width="70px" placeholder="추가 주소를 입력하세요">
        </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td>
         <input type="text" name="mem_email" > *직접입력해주세요
       </td>
      </tr>
      <p />
     </table>
     ...
     <h2><b>회원 동의 약관</b></h2>
     <textarea cols="150" rows="20" name="agree">
	 제 1 조 (약관의 적용)
	...
	<b>제 5 장  손해배상</b>
 	...
 	<input type="button" value="동의합니다." id="agree_btn" > 
 	<input type="button" value="동의하지 않습니다." id="disagree_btn" onclick="history.back()">
 	</div> <!-- 이용약관 -->  
      	
 	<hr>
     <div>
       <button type="button" id="join_end_btn" onclick="checkAll()">회원가입</button>
      <button type="button" id="join_close_btn"><a href="login.jsp">닫기</a></button>
